...
|---|---|---|
| `FLOW_TEMPLATE_SPEC` | `$HOME/.claude/cells/code-pipeline/templates/spec.md` | Path to the spec template used by `bootstrap.sh`. |
...
A starter file written by `/cell config`; edit values as needed.
